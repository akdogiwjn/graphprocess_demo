...
void parallel_accumulator(int clk, int rst,
                          int front_src[16], int front_acc_id[16], int front_src_valid,
...
void parallel_accumulator_update(int clk, int rst,
                                 ...
                                 int src[16], int *src_valid)
{
    static int src_level_1[16], acc_id_level_1[16], src_level_1_valid;
    static int src_level_2[16], acc_id_level_2[16], src_level_2_valid;
    static int src_level_3[16], acc_id_level_3[16], src_level_3_valid;
    static int src_level_4[16], acc_id_level_4[16], src_level_4_valid;
    ...
    void parallel_accumulator_update_adder(int clk, int rst,
                                           int din_1, int idin_1, int din_2, int idin_2,
